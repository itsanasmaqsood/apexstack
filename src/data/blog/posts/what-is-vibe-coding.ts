...
export const post: BlogPost = {
  ...
  seoTitle: "What Is Vibe Coding? A Founder's Honest Guide | ApexStack",
  description: "A practical guide to what is vibe coding, covering scope, evidence, ownership, delivery risk and the next decision for founders.",
  excerpt: "A buyer-focused guide to what is vibe coding: define the decision, request useful evidence and keep the first release accountable.",
  category: "AI Engineering",
  primaryKeyword: "what is vibe coding",
  secondaryKeywords: [
    "what is vibe coding checklist",
    "what is vibe coding scope",
    "what is vibe coding risks",
  ],
  published: "2026-06-13",
  updated: "2026-08-24",
  authorId: "leadership-01",
  serviceSlug: "mvp-development",
  keyTakeaway: "Treat the first release as a controlled learning step: one narrow workflow, explicit quality checks and clear ownership after launch. The scope should address model limits, code ownership, data access, evaluation and a maintainable handover. For the buyer question “What Is Vibe Coding? A Founder's Honest Guide”, define one core workflow, explicit exclusions, acceptance evidence, account ownership and a handover plan before committing to implementation.",
  sections: [
    {
