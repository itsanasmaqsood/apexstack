...
export const post: BlogPost = {
  ...
  seoTitle: "Vibe Coding Agency: What to Look For Before You | ApexStack",
  description: "A practical guide to vibe coding agency, covering scope, evidence, ownership, delivery risk and the next decision for founders.",
  excerpt: "A buyer-focused guide to vibe coding agency: define the decision, request useful evidence and keep the first release accountable.",
  category: "Choosing a Partner",
  primaryKeyword: "vibe coding agency",
  secondaryKeywords: [
    "vibe coding agency checklist",
    "vibe coding agency scope",
  ...
  keyTakeaway: "Choose a delivery partner by examining who owns discovery, technical decisions, quality checks, deployment and handover. The proposal should be explicit about model limits, code ownership, data access, evaluation and a maintainable handover. For the buyer question “Vibe Coding Agency: What to Look For Before You Hire”, define one core workflow, explicit exclusions, acceptance evidence, account ownership and a handover plan before committing to implementation.",
  sections: [
    {
