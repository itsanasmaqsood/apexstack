...
export const post: BlogPost = {
  slug: "best-mvp-development-studios-non-technical-founders",
  ...
  description: "A practical guide to best mvp development studios non technical founders, covering scope, evidence, ownership, delivery risk and the next decision for",
  excerpt: "A buyer-focused guide to best mvp development studios non technical founders: define the decision, request useful evidence and keep the first release accountable.",
  category: "Choosing a Partner",
  primaryKeyword: "best mvp development studios non technical founders",
  secondaryKeywords: [
    "best mvp development studios non technical founders checklist",
    "best mvp development studios non technical founders scope",
    "best mvp development studios non technical founders risks",
  ],
